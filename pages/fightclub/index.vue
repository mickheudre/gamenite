            ...
            <template #event="{ event, view }">
                <div class="relative h-full w-full p-2 z-0" @click="onEventClick(event, null)">
                    ...
                    <div class="relative vuecal__event-title md:mx-2 text-white text-sm  font-semibold my-2 items-center justify-center z-30 " >
                        ...
                        <UIcon v-else-if="event.class=='event' && event.type.Nom == 'Tournoi'" class="text-xl" name="i-heroicons-trophy" />
                        <UIcon v-else-if="event.class=='event' && event.type.Nom == 'Soirée Privée'" class="text-xl" name="i-heroicons-exclamation-circle" />
                        <UIcon v-else-if="event.class=='event' && event.type.Nom == 'Soirée Peinture'" class="text-xl" name="i-heroicons-paint-brush" />
